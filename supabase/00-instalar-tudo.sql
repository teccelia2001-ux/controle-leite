-- ============================================================
-- INSTALAR TUDO - Controle de producao de leite (Supabase)
-- Rodar UMA vez em: Supabase > SQL Editor > New query > cola > Run
--
-- Este arquivo e a juncao dos outros dois, na ordem correta:
--   1) supabase-esquema.sql            (perfis, registros, gastos, ajustes)
--   2) supabase-produtores-sem-login.sql (produtores_livres)
-- A ordem importa: produtores_livres referencia perfis e usa a
-- funcao marcar_hora(), ambas criadas na parte 1.
--
-- Tudo usa "if not exists" / "create or replace", entao rodar de
-- novo em um banco que ja tem as tabelas nao apaga nada.
-- ============================================================
